...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public EmojiIndicatorView(Context context, AttributeSet attrs) {
        ...
        mMaxHeight = EmojiUtil.dip2px(mContext, mHeight);
        bmpSelect= BitmapFactory.decodeResource(getResources(), R.drawable.emoji84);
        bmpNomal= BitmapFactory.decodeResource(getResources(), R.drawable.emoji83);
    }
