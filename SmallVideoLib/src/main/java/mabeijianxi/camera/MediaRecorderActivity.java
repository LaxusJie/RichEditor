...
public class MediaRecorderActivity extends Activity implements
    ...
    private void loadViews() {
        ...
        mVideoBack = (ImageView) findViewById(R.id.iv_video_back);
        ...
        mRecordTime = (TextView) findViewById(R.id.tv_video_time);
        mBottomLayout = (RelativeLayout) findViewById(R.id.bottom_layout);
        mRecordLed = (CheckBox) findViewById(R.id.record_camera_led);
        mRecordStart = (Button) findViewById(R.id.btn_start);
        mRecordStop = (Button) findViewById(R.id.btn_stop);
...
//            mSurfaceView.setOnTouchListener(mOnSurfaveViewTouchListener);
    ...
    private void startRecord() {
        videoTime = new VideoTime(60000,1000);
        videoTime.start();
        if (mMediaRecorder != null) {
...
//        mRecordController.animate().scaleX(1).scaleY(1).setDuration(500).start();
    ...
    public void onEncodeComplete() {
        ...
        try {
            ...
            intent.putExtra(MediaRecorderActivity.VIDEO_DURATION, mMediaObject.getDuration());
    ...
    class VideoTime extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            ...
            mRecordTime.setText((millisUntilFinished / 1000) + "S");
        }
